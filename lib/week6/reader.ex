defmodule Week6.StreamReader do
  use GenServer
  require Logger
  ...
  def handle_info(%HTTPoison.AsyncChunk{chunk: chunk}, _state) do
    ...
    case chunk do
      ...
      "event: \"message\"\n\ndata: {\"message\": panic}\n\n" ->
        Week6.GenericLoadBalancer.send_work(:printer,{:kill, "kill message"})

      "event: \"message\"\n\ndata: " <> message ->
        Week6.GenericLoadBalancer.send_work(:printer,message)

      "" -> Week6.GenericLoadBalancer.send_work(:printer,"")
