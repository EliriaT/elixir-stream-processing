defmodule Redacter6 do
  ...
  def filter_bad_words(tweet_id, msg) do
    Week6.GenericLoadBalancer.send_work(:redacter, {tweet_id,  msg})
  ...
  def handle_cast({tweet_id,  msg}, state) do
    ...
    Week6.Aggregator.aggregate({:cleaner, %{id: tweet_id, cleaned: clean_msg}})

    # Week6.Batcher.send_to_batch(clean_msg)
    # IO.puts(
    #   "\n\n" <>
