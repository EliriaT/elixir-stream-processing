defmodule SentAnalyserB do
  ...
  def calculate_sentiment(tweet) do
    Week4B.GenericLoadBalancer.send_work(:sentiment, {:calculateSent, tweet})
  ...
  def handle_cast({:calculateSent, tweet}, state) do
