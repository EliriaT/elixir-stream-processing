defmodule SentAnalyser5 do
  ...
  def calculate_sentiment(tweet_id,tweet) do
    Week5.GenericLoadBalancer.send_work(:sentiment, {:calculateSent,tweet_id, tweet})
  ...
  def handle_cast({:calculateSent,tweet_id, tweet}, state) do
    ...
    Week5.Aggregator.aggregate({:sentiment, %{id: tweet_id, score: mean_score}})
