defmodule Week5.StreamReader do
  use GenServer
  require Logger
  ...
  def handle_info(%HTTPoison.AsyncChunk{chunk: chunk}, _state) do
    ...
    case chunk do
      ...
      "event: \"message\"\n\ndata: {\"message\": panic}\n\n" ->
        Week5.GenericLoadBalancer.send_work(:printer,{:kill, "kill message"})

      "event: \"message\"\n\ndata: " <> message ->
        Week5.GenericLoadBalancer.send_work(:printer,message)

      "" -> Week5.GenericLoadBalancer.send_work(:printer,"")
