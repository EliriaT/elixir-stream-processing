defmodule Week4.StreamReader do
  use GenServer
  require Logger
  ...
  def handle_info(%HTTPoison.AsyncChunk{chunk: chunk}, _state) do
    ...
    case chunk do
      ...
      "event: \"message\"\n\ndata: {\"message\": panic}\n\n" ->
        Week4.LoadBalancer.print_tweets({:kill, "kill message"})

      "event: \"message\"\n\ndata: " <> message ->
        Week4.LoadBalancer.print_tweets(message)

      "" -> Week4.LoadBalancer.print_tweets("")
